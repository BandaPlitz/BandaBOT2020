...
Condition enterPressed = new Condition() {
		...
		RobotMap.getMotor("rarm").rotateDegrees(0.4, 60, false);
		...
		GyroFollow.followDegrees(Convert.cmToDegrees(73), -45, 0.4, 0.6, true);
		RobotMap.getChassis().tankDriveDegrees(0.25, -0.25, 130, false);
		RobotMap.getSensor("gyro").resetToCurrentValue();
		GyroFollow.followDegrees(Convert.cmToDegrees(55), -15, 0.9, -0.9, true);
